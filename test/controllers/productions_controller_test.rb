...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { description: @production.description, name: @production.name, release_date: @production.release_date }
    end
  ...
  test "should update production" do
    patch :update, id: @production, production: { description: @production.description, name: @production.name, release_date: @production.release_date }
    assert_redirected_to production_path(assigns(:production))
  end
